...
- [ ] https://boards.greenhouse.io/company/jobs/456 | Company Inc | Senior SWE
- [!] https://private.url/job — Error: login required

## Processed
- [x] #001 | https://jobs.example.com/posting/789 | Acme Corp | Backend Engineer | 4.2/5 | PDF ✅
- [x] #002 | https://boards.greenhouse.io/xyz/jobs/012 | BigCo | Junior SWE | 2.1/5 | PDF ❌
```
...
- **`local:` prefix**: Read the local file. Example: `local:jds/paylocity-backend.md` → read `jds/paylocity-backend.md`

## Auto-numbering

1. List all files in `reports/`
2. Extract the number from the prefix (e.g., `002-paylocity-...` → 2)
