...
**Tone rules:**
- **Confident without arrogance**: "I've spent the past two years shipping production software — your role is where I want to apply that experience next"
...
- **Relevant experience?** → One quantified proof point. "Built [X] that [outcome]."
- **Good fit?** → "I sit at the intersection of [A] and [B], which is exactly where this role lives."
- **How did you hear?** → Honest: "Found through [portal/scan], evaluated against my criteria, and it scored highest."

**Language**: Always match the language of the JD (EN default).
