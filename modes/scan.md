...
5. **Level 2 — Greenhouse APIs** (parallel):
   ...
   a. WebFetch the API URL → JSON list of jobs
...
- **Ashby**: `"Junior Backend Engineer (Remote) @ Supabase"` → title: `Junior Backend Engineer`, company: `Supabase`
- **Greenhouse**: `"Software Engineer at HubSpot"` → title: `Software Engineer`, company: `HubSpot`
- **Lever**: `"Junior Developer - Java @ Paylocity"` → title: `Junior Developer - Java`, company: `Paylocity`
...
https://...	2026-04-07	Greenhouse — Junior SWE	Junior SWE	HubSpot	added
https://...	2026-04-07	Ashby — Junior Engineer	Senior Staff	BigCo	skipped_title
https://...	2026-04-07	Greenhouse — Junior SWE	Backend Eng	Paylocity	skipped_dup
```
...
Every company in `tracked_companies` should have `careers_url` — the direct URL to their job listings page. This avoids looking it up every scan.

**Known patterns by platform:**
- **Ashby:** `https://jobs.ashbyhq.com/{slug}`
- **Greenhouse:** `https://job-boards.greenhouse.io/{slug}` or `https://job-boards.eu.greenhouse.io/{slug}`
- **Lever:** `https://jobs.lever.co/{slug}`
- **Custom:** The company's own URL (e.g., `https://paylocity.com/careers`)
...
- Add new queries as new portals or role types are discovered
