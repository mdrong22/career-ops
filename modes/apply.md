...
Interactive mode for when the candidate is filling out an application form. Reads what's on screen, loads prior evaluation context, and generates tailored answers for each form field.
...
2. Search `reports/` for the company name (Grep case-insensitive)
...
- **Notify the candidate**: "The role changed from [X] to [Y]. Should I re-evaluate or adapt the answers to the new title?"
...
5. **Proof point anchor**: Lead with what you built, not what you claim
